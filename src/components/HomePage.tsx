...
{/* <Box > */}
 ...
 <SimpleGrid columns={2}  spacingX={{sm:"100px",lg:'200px'}} spacingY={{sm:"100px",lg:'200px'}} bgImage={'https://c.top4top.io/p_260026l1s1.png'} >
  <Box m={'3%'}>
    <Text w={'auto'} 
    textAlign={'center'}
...
minWidth={"8rem"}
    ...
    src={'https://github.com/Bader975/README/assets/80196102/376c9286-5a37-46aa-9bcd-1cbbef13908d'} mixBlendMode={"darken"} alt='ImageHome' />
</Box>  
</SimpleGrid>
